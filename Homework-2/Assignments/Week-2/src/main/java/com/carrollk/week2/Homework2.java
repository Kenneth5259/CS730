...
class StringProcessor {
	...
	StackCharacter stackchar = new StackCharacter(sLength);	// create a stack at the length of elements present
 
	// Stack becomes 1
	for (int i = 0; i < str.length(); i++)                  	// scan the string from left toward right
    	{
        	char character = str.charAt(i);                     	// This reads the character value into the stack
